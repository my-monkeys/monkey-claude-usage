...
package let englishStrings: [String: String] = [
    ...
    "rename_account": "Name",
    "menu_bar_tag_help": "How this account is marked in the menu bar",
    "badge_automatic": "Automatic",
    "badge_help": "What marks this account in the menu bar. Left automatic, it is the first letter of the name.",
    "badge_letters": "Letters",
    "badge_symbol": "Symbol",
...
package let frenchStrings: [String: String] = [
    ...
    "rename_account": "Nom",
    "menu_bar_tag_help": "Comment ce compte est marqué dans la barre de menus",
    "badge_automatic": "Automatique",
    "badge_help": "Ce qui marque ce compte dans la barre de menus. En automatique, c’est la première lettre du nom.",
    "badge_letters": "Lettres",
    "badge_symbol": "Symbole",
