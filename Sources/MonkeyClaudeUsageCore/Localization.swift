...
let englishStrings: [String: String] = [
    ...
    "import_cli": "Use the account Claude Code is signed in as",
    "import_failed": "No Claude Code session found on this Mac.",
    "or": "or",
...
let frenchStrings: [String: String] = [
    ...
    "import_cli": "Utiliser le compte connecté dans Claude Code",
    "import_failed": "Aucune session Claude Code trouvée sur ce Mac.",
    "or": "ou",
    ...
    "about": "À propos",
    "open_dashboard": "Ouvrir claude.ai",
